...
- 借：纯黑场中的单一大圆主控、印与湿度是同一种物质、右上留给系统时间。
- 落点：Watch App 只保留右上系统时钟；今日印尽量占住玻璃，空心/实心表达待签与完成，边缘带着同一色的湿度；项目日若出现，只做印下一行小字。矩形 complication / Smart Stack 的历史节点汇入今日印。
- 不借：全屏流体、行星轨道、海报大数字、金色或霓虹发光、健康指标、多层进度环、轨道小字、月相题材和装饰线。
...
| Apple Watch | R5 | 今日印是唯一动作中心；湿度贴在印的边缘；右上留给系统时间 |
