...
- `../../../docs/RELEASE_SCOPE_1_0.md`：1.0 正式范围与发布门禁。
- `../../../docs/IMPLEMENTATION_STATUS.md`：当前实现和已经取得/尚未取得的证据；它是状态报告，不覆盖正式合同。
- `../../../design/BRAND_SPEC.md`：1.0 App、AppIcon 与商店素材的冻结视觉合同。
...
| 1.0 范围、明确排除项和上线门禁 | `../../../docs/RELEASE_SCOPE_1_0.md` |
| 1.0 App 视觉、导航、布局、颜色、AppIcon | `../../../design/BRAND_SPEC.md` |
| 正式颜色值与外观变体 | `../../../design/brand-tokens.json` |
| App 内基础落印与未来系统仪式的状态/时序 | `../../../docs/PULSE_RITUAL_CONTRACT.md` |
| 未来版本先后关系 | `../../../docs/POST_1_0_ROADMAP.md` |
...
- 1.0 范围只由 `RELEASE_SCOPE_1_0.md` 决定；路线图和仪式愿景不能把未来能力提前变成当前功能。
- 当前 1.0 App 视觉以 `design/BRAND_SPEC.md` 为准。该合同已经明确禁用旧黑白单色系统。
- `PULSE_RITUAL_CONTRACT.md` 控制仪式状态、时序、系统表面和未来体验语义，但不能覆盖 1.0 App 的冻结品牌方向。
- 若 `PULSE_RITUAL_CONTRACT.md` 仍写“纯黑单色”，将其作为待修复的文档冲突上报；对 1.0 App 不执行该句，也不把草绿系统和黑白旧系统混成新方向。未经用户授权不要顺手修改合同。
