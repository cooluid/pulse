...
- App 构图画廊与真实 Home Screen 小号/中号必须分别验证待落之处、落印、叠印、数影、手札、静场、来路、潮痕，并以 [widget-ritual-objects](./prototypes/widget-ritual-objects/) 的正式清单为构图对照。待落之处检查小号单轴、中号左右分区、待办空坑与完成实心勾，且不得出现开放日环或渐变；落印检查大开口日环与完成闭合；叠印检查最多三层纸边、文字与日号完整且不与数影抢主角；数影检查 `1 / 10 / 11 / 31` 的半屏完整字形；手札检查蜡封与等大邮戳；静场检查残影从右下印心扩开且不是手札放大版；来路检查由远及近的六日印与今日环心日号；潮痕检查天际、潮唇、一尾鱼、无大日号，以及完成时潮位与闭环变化。画廊必须同时显示同一正式渲染器的小号与中号，不得只用中号预览替代小号验收；末款完整可见，旧五式不得重新进入枚举、字符串或截图基线。
