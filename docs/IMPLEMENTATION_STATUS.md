...
- UI 自动化覆盖首次签到、终止重启持久化、历史同步、显式双向翻月、漏签非颜色语义、设置辅助功能隔离，以及 Accessibility XXXL 主操作与等宽底栏几何。
...
- 人工完成 VoiceOver、最大字号、深浅色、高对比度、降低透明度、Reduce Motion、旋转和 iPad 分屏验收。
