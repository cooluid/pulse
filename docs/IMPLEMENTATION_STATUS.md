...
- Home Screen Widget 构图方向真源与正式共享渲染源已统一为八种仪式物件：待落之处、星环、叠印、数影、手札、静场、来路、潮痕，见 [docs/prototypes/widget-ritual-objects/](./prototypes/widget-ritual-objects/) 的正式清单；待落之处像素构图真源为 [widget-awaiting-place](./prototypes/widget-awaiting-place/pulse-widget-awaiting-place.html)，潮痕像素构图真源为 [01-tide-mark](./prototypes/widget-style-experiments/01-tide-mark/pulse-widget-tide-mark.html)。待落之处是唯一免费及默认构图，星环与其余六式统一由高阶权益解锁；应用内核心签到“落印”动作仍永久免费。App 画廊与 Extension 消费同一 `PulseWidgetHomeRenderer`；旧 `.seal` 构图、旧五式枚举、旧骨架、独立近似预览、硬编码假日期和重复七日摘要已删除。当前精修以“低彩度环境 + 高覆盖仪式物件 + 清楚明度层级”为统一质感：Widget 容器统一使用品牌环境底，只有真实纸面使用 surface；八式分别以留位场、开口星环、桌垫、雾场、信纸环境、静场残影、路径地面与潮面建立填充，不套同一张装饰皮。星环以品牌开口环与环上唯一的一颗星建立身份；签到后开口合上、这颗星以亮过环壁的填色点亮并由行动色连续转为草绿；环心用低透明色场填住空洞并与环壁留沟槽，卡片底场保持低彩度，只用环境椭圆补一层轻色。旧气态主星、六颗伴星、`starTrail` 断续尾迹、散落圆点、黑色宇宙底和统计仪表盘均不保留。叠印恒定为四页物理纸叠，纸层只表达厚度和触感，完全不映射历史、连续天数或计数；被否决的历史层数投影及其测试已删除。手札 clean-break 为单张笺纸，以左笺边、两条低对比书写纹、带日号的主日戳和过去六日邮路印建立身份；左上不再重复日号，底部也不再混入今天或显示节点日期，旧独立蜡封、通用勾号与第七枚今天邮戳已经删除，不再与叠印共用多纸语法。静场只加深右下回响核心及第一圈，不整体压暗；来路删除连续图表曲线和日期节点，以鞋底加趾印形成空间轨迹，并从不可变快照即时派生唯一一次 `六日 · N 印`，不保存派生计数。画廊权益徽章降为次级说明。用户提供的真实主屏截图曾否决此前叠印版本；当前仍须新真机主屏截图复验，不用 App 画廊代替 Widget host 结论。
