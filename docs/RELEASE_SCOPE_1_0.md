...
文档版本：1.0
状态：功能范围、B 方向视觉系统与 B2 AppIcon 已冻结；发布身份与最终界面验收待确认
更新时间：2026-08-10
...
| Bundle ID | `cool.pulse` | 待确认其归属与长期稳定性 |
...
2. 真实 iPhone 完成签到、重启持久化、触觉和通知全流程。
3. 真实 iPad 完成横竖屏和分屏验证。
4. 签名 Archive、TestFlight 安装、升级和恢复流程通过。
5. 隐私说明、支持页面、商店文案和截图完成。
6. Bundle ID、显示名称、版本号和支持设备范围正式签字确认。
7. 至少完成一轮跨多个自然日的内部试用。
