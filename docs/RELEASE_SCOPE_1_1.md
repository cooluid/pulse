...
- 签到成功后可选“留一张今天”：只在用户点击时请求相机权限，不自动打开相机，不提供相册或伪造拍照 fallback。
...
- 免费基础提醒、一次买断“一日一印增强”、四种 Home Screen Widget 构图与 iOS 26 scheduled Live Activity，沿用正式权益合同。
...
当前一次买断增强仍只售卖高级 Widget 构图和支持设备上的 scheduled Live Activity。未来“岁月流影”的自动对齐、真实时间轴融合、年度影片和高分辨率渲染可以形成新的高级权益，但不得锁住、删除或降级既有原图，也不得把人脸识别、颜值/年龄推断或远程人脸处理包装为卖点。
