...
- 单击开放日环只签到；长按 0.45 秒执行“签到并拍照”：先完成同一权威签到事务，成功后才请求相机。签到后的“拍下今天”仍可独立进入，不提供相册或伪造拍照 fallback。
...
- 免费基础提醒、一次买断“野印”、四种 Home Screen Widget 构图与 iOS 26 scheduled Live Activity，沿用正式权益合同。
...
野印当前售卖高级 Widget 构图和支持设备上的 scheduled Live Activity。`PulseEnhancementContract.currentCapabilities` 是购买页唯一已交付能力目录；同一永久权益可以在后续版本增值，但新能力只有真正交付后才能进入目录，不能预售路线图。未来能力不得锁住、删除或降级既有原图，也不得把人脸识别、颜值/年龄推断或远程人脸处理包装为卖点。
