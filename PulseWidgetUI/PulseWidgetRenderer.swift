...
enum PulseWidgetDesign {
    ...
    static let activitySoftWhite = Color(red: 0.96, green: 0.97, blue: 0.91)
    static let activityFirefly = Color(red: 0.98, green: 0.86, blue: 0.34)
    static let activityPulseLight = Color(red: 0.58, green: 0.96, blue: 0.72)
    static let activityPressShadow = Color(red: 0.10, green: 0.24, blue: 0.12)
    static let activityCompletionAnimationDuration: TimeInterval = 1.25
    static let activityHeroHeight: CGFloat = 76
    static let activityHeroHorizontalInset: CGFloat = 12
    static let activityPreviewCameraClearance: CGFloat = 20
    static let activityPreviewHorizontalInset: CGFloat = 14
    static let activityPreviewVerticalInset: CGFloat = 10
    static let activityPreviewCornerRadius: CGFloat = 38
