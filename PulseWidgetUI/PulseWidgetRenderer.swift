...
enum PulseWidgetDesign {
    ...
    static let activityPrimary = Color.white
    static let activitySecondary = Color.white.opacity(0.72)
    static let activityActionForeground = Color.black
    static let activityMarkMinimumStrokeWidth: CGFloat = 2
    static let activityDayRingStrokeRatio: CGFloat = 0.10
    static let activityDayRingCheckRatio: CGFloat = 0.38
    static let activityDayRingEndpointRatio: CGFloat = 0.17
    static let activityPressCornerRatio: CGFloat = 0.24
    static let activityPressStrokeRatio: CGFloat = 0.09
    static let activityPressInnerCornerRatio: CGFloat = 0.18
    static let activityPressInnerInsetRatio: CGFloat = 0.18
    static let activityPressCheckRatio: CGFloat = 0.30
    static let activityPressBarWidthRatio: CGFloat = 0.42
    static let activityPressBarHeightRatio: CGFloat = 0.10
    static let activitySplitMutedOpacity: CGFloat = 0.34
    static let activitySplitStrongOpacity: CGFloat = 0.72
    static let activitySplitTraceWidthRatio: CGFloat = 0.16
    static let activitySplitMutedHeightRatio: CGFloat = 0.72
    static let activitySplitPendingHeightRatio: CGFloat = 0.60
    static let activitySplitCompletedHeightRatio: CGFloat = 0.90
    static let activitySplitDotRatio: CGFloat = 0.20
    static let activitySplitLeftRotation = -34.0
    static let activitySplitRightRotation = 34.0
    static let activitySplitLeftOffsetRatio: CGFloat = -0.16
    static let activitySplitRightOffsetRatio: CGFloat = 0.12
    static let activitySplitDotOffsetRatio: CGFloat = -0.30
    static let activityAccentOpacity: CGFloat = 0.72
    static let activityAccentCornerRadius: CGFloat = 2
    static let activityAccentSplitSpacing: CGFloat = 2
    static let activityAccentSplitRotation = 24.0
    static let activityActionHorizontalInset: CGFloat = 14
    static let activityActionMinimumHeight: CGFloat = 36
    static let activityAccentLineWidth: CGFloat = 18
    static let activityAccentLineHeight: CGFloat = 3
    static let activityAccentSquareSide: CGFloat = 12
    static let activityAccentSplitWidth: CGFloat = 3
    static let activityAccentSplitHeight: CGFloat = 14
    static let activitySplitColumnSpacing: CGFloat = 10
    static let activitySplitSeparatorWidth: CGFloat = 1
    static let activitySplitSeparatorHeight: CGFloat = 34
    static let activitySplitSeparatorOpacity: CGFloat = 0.42
    static let activityLockScreenSpacing: CGFloat = 12
    static let activityLockScreenMarkSize: CGFloat = 42
    static let activityPreviewSpacing: CGFloat = 10
    static let activityPreviewMarkSize: CGFloat = 30
    static let activityPreviewHorizontalInset: CGFloat = 16
    static let activityPreviewVerticalInset: CGFloat = 14
